...
_PHRASE_ALIASES: dict[str, list[str]] = {
    ...
    # Badminton rules - additional
    "continuous play": ["chơi liên tục", "luật chơi liên tục"],
    "disqualification": ["bị loại", "trừ quyền thi đấu"],
    "medical timeout": ["thời gian nghỉ y tế", "nghỉ chấn thương"],
    "point": ["điểm", "điểm số"],
    "interval": ["nghỉ giữa hiệp", "thời gian nghỉ"],
    "warning": ["cảnh báo", "thẻ cảnh cáo"],
    "umpire": ["trọng tài", "giám sát"],
    "the receiver not being ready": ["người nhận chưa sẵn sàng"],
    "the server taking too long": ["người giao quá lâu"],
    # Pickleball
    ...
    "safety": ["đánh an toàn"],
    # Additional terms
    "masse": ["masse", "đánh cong bi"],
    "masse shot": ["cú masse", "đánh cong bi cue"],
    "defensive play": ["phòng thủ", "chơi phòng thủ"],
    "defensive clear": ["phông cầu phòng thủ", "clear phòng thủ"],
    "overhead clear": ["phông cầu cao", "clear cao"],
    "attacking clear": ["phông cầu tấn công", "clear tấn công"],
    "cross-court drop": ["bỏ nhỏ chéo sân", "drop chéo"],
    "deceptive drop": ["bỏ nhỏ giả", "drop giả"],
    "fast drop": ["bỏ nhỏ nhanh", "drop nhanh"],
    "slow drop": ["bỏ nhỏ chậm", "drop chậm"],
    "straight drop": ["bỏ nhỏ thẳng", "drop thẳng"],
    "third shot drop": ["bỏ nhỏ quả thứ ba", "drop quả 3"],
    "basic dink": ["dink cơ bản", "bỏ nhỏ cơ bản"],
    "dinking": ["đánh dink", "chơi dink"],
    "dink battles": ["đấu dink", "tranh chấp dink"],
    "speed-up": ["tăng tốc", "đánh nhanh"],
    "spin": ["xoáy", "spin"],
    "topspin": ["xoáy trên", "topspin"],
    "backspin": ["xoáy dưới", "backspin"],
    "side spin": ["xoáy ngang", "side spin"],
    "english": ["xoáy", "tiếng anh (bi-da)"],
    "cue stick": ["cơ bida", "gậy bida"],
    "chalk": ["phấn", "phấn cơ"],
    "bridge": ["giá đỡ", "tay cầu"],
    "jump shot": ["bi nhảy", "cú nhảy"],
    "massé": ["masse", "đánh cong"],
    "carom": ["carom", "bi chạm"],
    "cushion": ["băng", "thành bàn"],
    "rail": ["băng", "thành bàn"],
    "head string": ["vạch đầu bàn", "đường đầu"],
    "foot spot": ["chân bàn", "điểm chân"],
    "center spot": ["giữa bàn", "điểm trung tâm"],
    "inning": ["lượt chơi", "inning"],
    "open table": ["bàn mở", "bàn tự do"],
    "game": ["trận", "game"],
    "match": ["trận đấu", "match"],
    "set": ["set", "ván"],
    "rally": ["pha cầu", "rally"],
    "shuttle": ["quả cầu", "cầu"],
    "baseline": ["vạch cuối sân", "đường cuối"],
    "net shot": ["cầu lưới", "đánh lưới"],
    "drop": ["bỏ nhỏ", "drop"],
    "clear": ["phông cầu", "clear"],
    "smash": ["đập cầu", "smash"],
    "lob": ["lốp cầu", "phông cầu"],
    "drive": ["đánh ngang", "drive"],
    "deception": ["giả", "đánh lừa"],
    "footwork": ["bộ chân", "di chuyển"],
    "grip": ["cầm vợt", "cách cầm vợt"],
    "serve": ["giao cầu", "phát cầu"],
    "service": ["giao cầu", "phát cầu"],
    "fault": ["lỗi", "phạm lỗi"],
    "let": ["đánh lại", "let"],
    "singles": ["đơn", "đánh đơn"],
    "doubles": ["đôi", "đánh đôi"],
    "mixed doubles": ["đôi nam nữ", "đôi hỗn hợp"],
    "paddle": ["vợt pickleball", "vợt"],
    "kitchen": ["vùng cấm volley", "kitchen"],
    "dink": ["dink", "bỏ nhỏ pickleball"],
    "volley": ["volley", "đánh bóng trên không"],
    "third shot": ["quả thứ ba", "third shot"],
    "side out": ["đổi quyền giao", "side out"],
    "rally scoring": ["tính điểm rally", "tính điểm mỗi pha"],
    "cue ball": ["bi cái", "bi trắng"],
    "object ball": ["bi mục tiêu", "bi đánh"],
    "pocket": ["lỗ", "túi"],
    "break": ["cú phá", "khai cuộc"],
    "safety": ["đánh an toàn", "phòng thủ"],
    "bank shot": ["đánh băng", "bi băng"],
    "kick shot": ["đánh đá băng", "bi đá băng"],
    "combo shot": ["đánh combo", "bi kết hợp"],
    "carom shot": ["đánh carom", "bi chạm"],
    "massé shot": ["cú masse", "đánh cong bi"],
    "jump shot": ["bi nhảy", "cú nhảy bi"],
    "english": ["xoáy", "spin"],
    "diamond": ["kim cương", "diamond"],
    "bridge": ["giá đỡ cơ", "tay cầu"],
    "rail": ["băng", "thành bàn"],
    "felt": ["vải bàn", "mặt bàn"],
    "chalk": ["phấn", "phấn cơ"],
}
...
_VI_TO_EN_ALIASES: dict[str, list[str]] = {
    ...
    # Additional Vietnamese to English
    "phòng thủ": ["defensive", "defense", "safety"],
    "đánh an toàn": ["safety", "defensive play"],
    "đánh cong": ["masse", "massé"],
    "bi cong": ["masse shot", "massé"],
    "đánh băng": ["bank shot", "kick shot"],
    "bi đá băng": ["kick shot", "bank shot"],
    "bi chạm": ["carom", "carom shot"],
    "xoáy": ["spin", "english", "topspin", "backspin"],
    "bỏ nhỏ chéo": ["cross-court drop", "drop shot"],
    "phông cầu cao": ["overhead clear", "clear"],
    "đánh lưới": ["net shot", "drop shot"],
    "quả thứ ba": ["third shot", "third shot drop"],
    "đấu dink": ["dink battles", "dinking"],
    "tăng tốc": ["speed-up", "speed up"],
    "đôi nam nữ": ["mixed doubles"],
    "đổi quyền giao": ["side out"],
    "trận đấu": ["match", "game"],
    "lượt chơi": ["inning", "turn"],
    "bàn mở": ["open table"],
    "vạch đầu bàn": ["head string"],
    "chân bàn": ["foot spot"],
    "giữa bàn": ["center spot"],
    "băng": ["cushion", "rail"],
    "thành bàn": ["cushion", "rail"],
    "mặt bàn": ["felt", "cloth"],
    "phấn": ["chalk"],
    "giá đỡ": ["bridge"],
    "bi nhảy": ["jump shot"],
    "lỗ": ["pocket"],
    "bi trắng": ["cue ball"],
    "bi đen": ["eight ball", "8-ball"],
    "bi màu": ["object ball", "colored ball"],
    "quả cầu": ["shuttlecock", "shuttle"],
    "vợt": ["racket", "paddle"],
    "sân": ["court"],
    "lưới": ["net"],
    "đường biên": ["boundary", "line"],
    "điểm": ["point", "score"],
    "ván": ["set", "game"],
    "thắng": ["win"],
    "thua": ["lose"],
